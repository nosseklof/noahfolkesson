...
const customIntros = {
  // Odeshog - 0509
  "0509": "Ödeshög stretches from fertile plains along Vättern to more rugged inland ground, giving it a long history of both crop farming and grazing. Dairy has been part of rural life but never dominant, with mixed farming shaping most of the area. The municipality is also rich in cultural heritage, home to some of Sweden’s highest concentrations of rune stones and ancient sites that anchor the landscape in deep history. Ödeshög has seen signficant decreases in both diary farms and dairy cows between 2003 and 2023, with the remaining seven dairy farms staying small (with an average of 53 dairy cows in 2023) and leaving a countryside shaped by larger crop operations",
  // Ydre - 0512
  ...
  // Linkoping - 0580
  "0580": "Some of Sweden’s richest farmland surround Ostergotland's biggest city Linkoping, where grain, oilseeds, and cattle have defined rural life for generations. Dairy exists but has never been the main driver compared to the strong arable tradition. As the city has grown and farms have modernised, the countryside now reflects a pattern of larger, more specialised operations shaping the plains. Between 2003 and 2023, has seen a signifiant decrease in the number of dairy farms, while it is one of few municipalities were the number of dairy cows has increased. The average herd in the municipality now constist of 180 cows compared to 57 in 2003. This reflects Linkopings increasing importance in dairy production, as it now has some of the highest density of both dairy farms and cows in the county.",
  // Norrkoping - 0581
